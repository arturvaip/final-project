        ...
        const translations = {
            ru: {
             ...
             r140: "Ловкость",  
             r141: "Интеллект",
             r142: "Перед тем, как продолжить, хочу сказать, что путь магии был для меня самым сложным, и я надеюсь, что вам понравится.",
             r143: "Открыв дверь магии, ты видишь ещё две двери: на одной—символ глаза, на другой—часов.",
             r144: "В какую дверь тебе лучше войти?",
             r145: "Часы",
             r146: "Глаз",
             r147: "Ты выбираешь дверь с песочными часами. За ней — каменный зал, где в воздухе парят часы. В центре арка с вращающимся механизмом. Стоит коснуться — и всё замирает…",
             r148: "Ты чувствуешь, как время вокруг подчиняется твоей воле.",
             r149: "Ты оказываешься в древнем храме: вокруг — разрушенные статуи и звук капающей воды. Перед тобой два прохода.",
             r150: "На стене выведена надпись: «Истина часто прячется в тени».",
             r151: "Пойти налево — тёмный и забытый путь.",
             r152: "Пойти направо — яркий и манящий.",
             r153: "Пройдя вперёд, ты выходишь к зеркалу. В нём отражён ты — но старше. Он спрашивает: «Ты владеешь магией времени, но осознаёшь ли её цену?»",
             r154: "Мир вокруг рушится, и ты падаешь в временную воронку. Оказываешься в будущем: металлические башни, стеклянное небо. Люди боятся магии.",
             r155: "Ты видишь храм — последний оплот знаний. Хранитель предлагает сделать выбор:",
             r156: "Это важный выбор, выбирай с умом.",
             r157: "Уничтожить магию времени, чтобы спасти будущее.",
             r158: "Сохранить её любой ценой — знание слишком ценно.",
             r159: "Каким бы ни был выбор, ты проходишь ритуал слияния и чувствуешь, как душа вплетается в ткань времени.",
             r160: "Ты видишь свои прошлые ошибки и решения — всё как на ладони.",
             r161: "Ты возвращаешься туда, где всё началось. Механизм часов останавливается, и ты можешь заморозить этот момент или отпустить время.",
             r162: "Уничтожив магию, ты принёс стабильность миру. Ты исчез, оставив свой след в истории.",
             r163: "Сохранив магию, ты стал Хранителем времени, но навсегда остался вне эпох.",
             r164: "Перед тобой открылся портал, и ты видишь будущее, где магия и технологии объединены. Ты — первооткрыватель новой эры.",
             r165: "Ты открываешь дверь с символом глаза. Мир дрожит, словно ткань, стены замка тают. Перед тобой — бесконечный мерцающий лес.",
             r166: "Идя вперёд, ты замечаешь, как деревья меняют форму. Вокруг — сон, и голос шепчет:",
             r167: "«Иллюзия — не ложь, а ещё одна правда».",
             r168: "Перед тобой два пути: мост из света или мрачная тропа сквозь туман.",
             r169: "Светлый путь",
             r170: "Мрачный путь",
             r171: "Ты встречаешь женщину в белом. Она ищет выход, но стоит отвернуться — её лицо меняется.",
             r172: "Она шепчет: «Ты тоже хочешь остаться здесь навсегда?»",
             r173: "Ты видишь своё отражение, и оно не двигается. Оно спрашивает: «Кем ты стал, следуя за иллюзиями?»",
             r174: "Ты находишь выход, ведущий к каменному кругу со словами: «Иллюзия или реальность — решает сердце».",
             r175: "Выйти и вернуться в «реальный» мир",
             r176: "Остаться в лесу и принять его домом.",
             r177: "Ты построил хижину. Лес стал ближе: ты лечишь зверей и постигаешь знания среди ветвей.",
             r178: "Путники называют тебя мудрецом. Ты лишь даришь им травы от боли и улыбаешься.",
             r179: "Сидя за столом, ты слышишь стук в дверь. Открыв, видишь фигуру с мечом, на рукояти — символ деревни. Ты тихо говоришь: «Ты несёшь знак древней силы. Заходи, я расскажу тебе больше».",
             r180: "Поздравляю! Это четвёртая хорошая концовка — сюжет обрывается здесь.",
             r181: "Поздравляю! Это пятая хорошая концовка — сюжет обрывается здесь.",
             r182: "Поздравляю! Это первая секретная концовка — сюжет обрывается здесь.",
             r183: "Поздравляю! Это шестая хорошая концовка — сюжет обрывается здесь, но начинаются новые истории.",
             r184: "«Новые пути начинаются не там, где их ждут…»",
             r185: "Спас короля",
             r186: "Уничтожил магию",
             r187: "Сохранил магию",
             r188: "P.S. Концовки считаются в порядке их создания, а не по ходу сюжета.",
             r189: "Ты возвращаешься — но всё стало серым и пустым. Магии нет; ты не можешь ни спать, ни видеть сны.",
             r190: "Поздравляю, это четвёртая плохая концовка.",
             r191: "Нашёл посох.",
             r192: "Нашёл посох иллюзий.",
             r193: "спокойноя жизнь",
            },
            he: { 
             ...
             r140: "זריזות",  
             r141: "תבונה",
             r142: "לפני שנמשיך, חשוב לומר: דרך הקסם הייתה הקשה מכול עבורי, ואני מקווה שתאהבו אותה.",
             r143: "כשאתה פותח את דלת הקסם, אתה רואה עוד שתי דלתות: אחת עם עין, והשנייה עם שעון חול.",
             r144: "באיזו דלת כדאי לך להיכנס?",
             r145: "שעון חול",
             r146: "עין",
             r147: "אתה פותח את הדלת עם שעון החול. לפניך אולם אבן, כששעונים תלויים באוויר. במרכז קשת עם מנגנון מסתובב. בכל נגיעה — הכל קופא…",
             r148: "אתה מרגיש שהזמן סביבך ציית לרצונך.",
             r149: "מוכר לך עצמך במקדש עתיק: סביבך פסלים שבורים וקולות טפטוף מים. לפניך שני מסלולים.",
             r150: "על הקיר חקוק: «האמת מסתתרת לעיתים בצללים».",
             r151: "ללכת שמאלה — דרך חשוכה ונשכחת.",
             r152: "ללכת ימינה — דרך מוארת ומפתה.",
             r153: "כשאתה מתקדם, אתה מגיע למראה. בתוכה אתה רואה את עצמך — מבוגר יותר. הוא שואל: «אתה שולט בכישוף הזמן, אך האם אתה מבין את מחירו?»",
             r154: "העולם סביבך מתפרק ואתה צולל למערבולת זמן. אתה מוצא את עצמך בעתיד: מגדלים מתכתיים ושמים מזכוכית. אנשים חוששים מכישוף.",
             r155: "אתה מבחין במקדש — המבצר האחרון של הידע. השומר מציע לך לבחור:",
             r156: "זוהי בחירה חשובה, בחר בחוכמה.",
             r157: "להשמיד את כישוף הזמן כדי להציל את העתיד.",
             r158: "לשמר אותו בכל מחיר — הידע יקר ערך.",
             r159: "לאחר הבחירה, אתה עובר טקס איחוד ומרגיש את נשמתך נשזרת במרקם הזמן.",
             r160: "אתה רואה את שגיאות העבר וההחלטות שלך — הכל גלוי לעיניך.",
             r161: "אתה חוזר אל המקום שבו הכל התחיל. מנגנון השעון נפסק, ואתה יכול לעצור את הרגע או לשחרר את הזמן.",
             r162: "כשתשמיד את הקסם, תביא יציבות לעולם. אתה תיעלם, אך תשאיר חותם בהיסטוריה.",
             r163: "כשאתה שומר את הקסם, אתה הופך לשומר הזמן, אך תישאר מחוץ לכל תקופה.",
             r164: "לפניך נפתח פורטל — אתה רואה עתיד בו קסם וטכנולוגיה מתמזגים. אתה החלוץ של עידן חדש.",
             r165: "אתה פותח דלת עם סמל העין. העולם רועד כאילו בד שהוא נוזל, קירות הטירה נעלמים. לפניך — יער אין־סופי ונוצץ.",
             r166: "כשאתה צועד, העצים משתנים וצורתם. הכל מרגיש כמו חלום, וקול לוחש:",
             r167: "«אשליה אינה שקר, אלא עוד אמת».",
             r168: "לפניך שני דרכים: גשר אור או שביל עכור בין ערפל.",
             r169: "הדרך המוארת",
             r170: "הדרך האפלילה",
             r171: "אתה פוגש אישה לבושה לבן. היא מחפשת מוצא, אך כשאתה מפנה מבט — פניה משתנות.",
             r172: "היא לוחשת: «גם אתה רוצה להישאר כאן לנצח?»",
             r173: "אתה רואה את השתקפותך, אך היא לא זזה. היא שואלת: «מי היית כשתלך בעקבות אשליות?»",
             r174: "אתה מוצא מוצא שמוביל למעגל אבן שעליו חקוק: «אשליה או מציאות — הלב הוא השופט».",
             r175: "לצאת ולחזור לעולם \'האמיתי\'",
             r176: "להישאר ביער ולקבל אותו כבית.",
             r177: "בנית צריף. עם כל יום העצים נהיים ידידים, אתה מרפא חיות פצועות ומגלה חוכמה בענפיהם.",
             r178: "עוברים ושבים קוראים לך חכם. אתה מחייך ומגיש להם רק עשבים להקלת הכאב.",
             r179: "כשאתה יושב ליד השולחן, דופקים בדלת. כשאתה פותח, אתה רואה דמות עם חרב שעל ידיתה סמל הכפר. אתה אומר: «אתה נושא עליך את סמל הכוח העתיק. בוא, אספר לך עוד.»",
             r180: "מזל טוב! זו הסיום הרביעית הטובה — הסיפור מסתיים כאן.",
             r181: "מזל טוב! זו הסיום החמישית הטובה — הסיפור מסתיים כאן.",
             r182: "מזל טוב! זו הסיום הסודית הראשונה — הסיפור מסתיים כאן.",
             r183: "מזל טוב! זו הסיום השישית הטובה — הסיפור מסתיים כאן, אך מתחילות הרפתקאות חדשות.",
             r184: "«דרכים חדשות מתחילות לא תמיד במקום המצופה…»",
             r185: "הצלת המלך",
             r186: "השמדת הקסם",
             r187: "שמירת הקסם",
             r188: "נ.ב. הסיומות נחשבות לפי סדר יצירתן, ולא לפי עלילת הסיפור.",
             r189: "אתה חוזר — אך הכל הפך לאפור וריק. אינך מרגיש יותר קסם; אינך יכול לישון או לחלום.",
             r190: "מזל טוב, זו הסיום הרביעית הרעה.",
             r191: "מצא מטה.",
             r192: "מצא את מטה האשליות.",
             r193: "חיים שקטים",
            }
        }    
      ...
      document.getElementById('he').addEventListener('click', () => {
        ...
        function show_titri() {
         ...
         document.querySelector("#plus-mark-mirni").textContent = playerData.mirni ? "➕" : "❌";
         ...
         console.log(`${translations[currentLang].r190} ${playerData.foundstuff ? '➕' : '❌'}`);
         console.log(`${translations[currentLang].r186} ${playerData.konc1 ? '➕' : '❌'}`);
         console.log(`${translations[currentLang].r187} ${playerData.konc2 ? '➕' : '❌'}`);
         console.log(`${translations[currentLang].r185} ${playerData.surking ? '➕' : '❌'}`);
         console.log(`${translations[currentLang].r192} ${playerData.foundstuffilusion ? '➕' : '❌'}`);
         console.log(`${translations[currentLang].r193} ${playerData.mirni ? '➕' : '❌'}`);
        }
        ...
        window.addEventListener('load', function() {
         ...
         document.getElementById('preloader').style.display = 'block';
            const backgroundImages = [
             ...
             'https://images.unsplash.com/photo-1638368888048-b4ee377101a9?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
             'https://images.unsplash.com/photo-1607066507041-33fc090b5a7d?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
             'https://images.unsplash.com/photo-1728755833852-2c138c84cfb1?q=80&w=1172&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
             'https://images.unsplash.com/photo-1617322715758-101c156a51cf?q=80&w=1172&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
             'https://cdn.pixabay.com/photo/2017/12/08/20/18/steampunk-3006650_1280.jpg',
             'https://cdn.pixabay.com/photo/2022/08/15/05/23/sun-rays-7387131_1280.jpg',
             'https://images.unsplash.com/photo-1662912031811-e9f6ff574498?q=80&w=977&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
             'https://images.stockcake.com/public/0/3/d/03d09025-02da-4151-95a3-3b1fe897b054_large/surreal-clock-tunnel-stockcake.jpg',
             'https://images.stockcake.com/public/6/d/1/6d1afc4c-0857-48ee-9146-82df598eeb9e_large/shattered-time-suspended-stockcake.jpg',
             'https://cdn.pixabay.com/photo/2016/11/06/23/51/buildings-1804481_1280.jpg',
             'https://images.stockcake.com/public/d/9/a/d9acb544-16d4-4c60-b817-ad1440b89262_large/time-breaking-apart-stockcake.jpg',
             'https://images.stockcake.com/public/3/9/f/39fef8f8-e0ac-4325-ac63-6dcf6ea6e7f0_large/magic-within-hands-stockcake.jpg',
             'https://cdn.pixabay.com/photo/2017/01/14/13/59/castelmezzano-1979546_1280.jpg',
             'https://cdn.pixabay.com/photo/2023/08/01/08/21/waterfall-8162449_1280.jpg',
             'https://images.stockcake.com/public/8/a/3/8a36c816-4744-4c87-9ec5-e506d32c5ea9_large/divergent-paths-ahead-stockcake.jpg',
             'https://images.unsplash.com/photo-1572851899654-7d97e5ec0107?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
             'https://images.stockcake.com/public/d/c/8/dc8fee55-938b-42b6-9781-a35d25b79657_large/forgotten-gothic-gateway-stockcake.jpg',
            ];
